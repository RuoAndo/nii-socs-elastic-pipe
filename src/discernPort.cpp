...
int traverse_file(char* filename, char* filelist_name, int thread_id, int portNo) {
...
void worker_func(thread_arg_t* arg) {
    ...
    while (1) {
        ...
        n = traverse_file(fname, filelist_name, thread_id, portNo);
...
int main(int argc, char* argv[]) {
    ...
    if (argc != 4) {
        printf("Usage: ./a.out DIR LIST portNO \n"); return 0;
    }
